...
const AdminDonors = Loadable(lazy(() => import('../pages/admin/Donors')))
const AdminDonorDetail = Loadable(lazy(() => import('../pages/admin/DonorDetail')))
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: paths.admin.donors,
        element: <RoleRoute requiredRole="admin"><AdminDonors /></RoleRoute>,
      },
      {
        path: paths.admin.donorDetail,
        element: <RoleRoute requiredRole="admin"><AdminDonorDetail /></RoleRoute>,
      },
      {
